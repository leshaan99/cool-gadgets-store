...
<div class="container">
    ...
    <!-- PRODUCT SECTION START HERE -->
        ...
        <button style=" background-color: #04AA6D; color: white; padding: 12px; border: none; width: 50%; margin:10%; border-radius: 3px; cursor: pointer; font-size: 17px;"><a href="payment.php">pay now</a></button> 
			<?php
			    if(!isset($_SESSION['customer_email'])){
