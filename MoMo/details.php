...
<body>
    ...
    <!-- NAVIGATION BAR STARTS HERE -->
        ...
        <div style="background-image: url('images/bg8.jpg');
                ...
                while($row_pro=mysqli_fetch_array($run_pro)){
                    ...
                    echo "
                        <div id='single_product_details'>
                            <a href='index.php?pro_id=$pro_id' id='product'>
                                ...
                                <p>$pro_desc</p>
                                <br>
                                <a href='index.php' id='goback' style='float:left'>Go Back</a> 
                            </a>
                        </div>
                    ";
                }
